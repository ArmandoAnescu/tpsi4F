...
void *stampaSaluti(void *par) // devo creare la "funzione" dove scrivo le istruzioni che deve eseguire il thread
{
    printf("%s \n", (char *)par);
    return (void *)0;
}
...
int main(int argc, char *argv[])
{
    ...
    printf("Ciao \n");
    pthread_create(&threadGiorno, NULL, &stampaSaluti, msg1); // indirizzo,Null,indirizzo della minima U di es che viene svolta
